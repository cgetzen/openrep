...
import { caroKannBranchTeaching } from './openings/caro-kann-branch-teaching.js?v=branch-briefings-v1';
import { OpenRepTrainerApp } from './practice-trainer.js?v=branch-briefings-v1';
